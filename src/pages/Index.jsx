...
const Index = () => {
  ...
  return (
    <Flex direction="column" h="100vh" justify="center" p={4}>
      ...
      <Flex direction={{ base: "column", md: "row" }} align="center" justify="center" mb={4} gap={4}>
        <VStack>
        ...
        <Button leftIcon={<FaTimes />} rightIcon={<FaArrowRight />} colorScheme="blue" size={buttonSize} mx={2}>
          Skip
        </Button>
        <VStack>
